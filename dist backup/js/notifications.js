...
window.handleNotificationClick = async function (event, id, isRead, type) {
    ...
    if (window.parent && typeof window.parent.navigateToPage === 'function') {
        if (type === 'special_collection' || type === 'pickup_request') {
            ...
            // Bin alerts and general alerts go to Sensor Monitoring or stay put
            // Navigating to 'bins' for actionable bin alerts
